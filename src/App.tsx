...
<img
          ...
          class="base"
          width="1100"
          alt="alt text regarding arrests by day"
        />

*/

import "./App.css";
import { Scrollable } from "./ImageContainer";
...
function App() {
  return (
    <>
      ...
      <section id="center">
        <h1 id="who-is-ice-">Who is ICE?</h1>
        <p>
      ...
      <section id="center">
        <h1 id="our-stance">Our Stance</h1>
        <p>
      ...
      <section id="center">
        <h1 id="melting-ice">Melting ICE</h1>
        <p>
          <b>
        ...
        <p>
          {" "}
          <img src={states} /> [which states are top 5?]
        </p>
        <p>
        ...
        <p>
          <img src={simple_citizen} />
          <em>
            reminder: we could not find 2013 arrest data, and have elected to
            interpolate that time span.
          </em>
        </p>
        <p>
      ...
      <section id="center">
        <h3 id="legislative-strategies">Legislative Strategies</h3>
        <p>
        ...
        <p>
          <img src={types} /> [selector for drug vs traffic to change text]
        </p>
        <p>
          <em>Drug charges</em>
          <br />
